...
(function () {
  ...
  const T = {
    de: {
      ...
      "products.desktop.summary": "Vollwertige Windows-App für strukturierte Dokumentenarbeit. Mehrbenutzer, Audit-Log, Lizenz-Verwaltung.",
      ...
      "products.desktop.cta": "Pilot-Anfrage stellen",
      ...
      "cta.h2": "Zwei Wege, MOM Shield kennenzulernen.",
      "cta.copy": "Probieren Sie die Chrome-Erweiterung kostenlos. Oder sprechen Sie uns für die Desktop-App und ein individuelles Pilot-Setup an.",
      "cta.btn2": "Kostenlose Chrome-Extension installieren",
      "cta.btn3": "oder Pilot-Anfrage stellen →",
      ...
      "support.files.p": "<strong>Browser-Erweiterung:</strong> txt, md, csv, json, xml, html, log, docx, xlsx und textbasierte PDF-Dateien.",
      "support.files.p2": "<strong>Desktop-App (ab v1.8):</strong> zusätzlich JPG, PNG, Screenshots und gescannte bzw. reine Bild-PDFs. Integrierte OCR erkennt sensible Inhalte direkt im Bild und ersetzt sie wahlweise durch strukturierte Platzhalter (Kontext bleibt für die KI verständlich) oder durch schwarze Balken (maximale Privatsphäre). Die Verarbeitung erfolgt vollständig lokal — Bilder verlassen das Gerät nicht.",
      ...
      "support.faq.q2": "Warum wurde ein PDF in der Browser-Erweiterung blockiert?",
      "support.faq.a2": "In der <strong>Browser-Erweiterung</strong> werden PDF-Dateien in Text umgewandelt und dann maskiert. Wenn ein PDF keine nutzbare Textebene hat, verschlüsselt ist oder nicht sicher extrahiert werden kann, blockiert die Erweiterung es, anstatt die Originaldatei unverändert durchzulassen. Für gescannte oder reine Bild-PDFs verwenden Sie bitte die <strong>Desktop-App</strong> — sie kann diese lokal per OCR verarbeiten und die erkannten Inhalte maskieren.",
      "support.faq.q3": "Unterstützt MOM Shield OCR für gescannte PDFs und Bilder?",
      "support.faq.a3": "<strong>Ja — in der Desktop-App ab v1.8.</strong> Gescannte PDFs, Screenshots und Bilddateien (JPG, PNG) werden lokal per integrierter OCR verarbeitet. Erkannte sensible Inhalte werden wahlweise durch strukturierte Platzhalter ersetzt (Kontext bleibt für die KI verständlich) oder vollständig mit schwarzen Balken überdeckt. Die <strong>Browser-Erweiterung</strong> enthält noch keine OCR — dort bleiben PDFs ohne Textebene blockiert.",
      ...
      "privacy.s3.li2": "Inhalte unterstützter Upload-Dateien — in der Browser-Erweiterung: txt, md, csv, json, xml, html, log, docx, xlsx und textbasierte PDF-Dateien; in der Desktop-App (ab v1.8) zusätzlich JPG, PNG, Screenshots und gescannte bzw. reine Bild-PDFs, die lokal per OCR verarbeitet werden",
    ...
    en: {
      ...
      "cta.h2": "Two ways to get to know MOM Shield.",
      "cta.copy": "Try the Chrome extension for free. Or talk to us about the desktop app and an individual pilot setup.",
      "cta.btn2": "Install the free Chrome extension",
      "cta.btn3": "or submit a pilot request →",
      "products.desktop.summary": "Full Windows app for structured document work. Multi-user, audit log, license management.",
      "products.desktop.cta": "Request a pilot",
